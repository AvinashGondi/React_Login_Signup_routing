          ...
          >
            <div className="form-row">
              ...
              <div className="col-12">
                <div className="input-group mb-3">
                  ...
                  <input
                    ...
                    id="password_login"
                    type="password"
                    onChange={onInputLoginPassword}
                    required={true}
                  ></input>
                  <div className="input-group-append">
                    <span
                      className="input-group-text"
                      onClick={password_show_hide_login}
                    >
              ...
              <div className="col-sm-12 pt-3 text-right">
                ...
                <p>
                  Already registered <Link to="/signup">Register</Link>
                </p>
              </div>
              <div className="col-12">
                <button className="btn btn-primary" type="submit" name="signin">
                  Login
                </button>
              </div>
            </div>
